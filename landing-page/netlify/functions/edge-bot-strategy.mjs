...
export default async (req) => {
  ...
  if (!getStrategy(strategy)) return json(400, { error: 'unknown_strategy', valid: ['trend_follow','mean_revert','breakout'] });
  ...
  if (sub.tier === 'watch') return json(403, { error: 'watch_tier_no_bot' });
  ...
  return json(200, { ok: true, strategy: data });
};
